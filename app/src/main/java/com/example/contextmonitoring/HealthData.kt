...
data class HealthData(
    ...
    override fun toString(): String {
        return "HealthData(id=$id, nausea_rating=$nausea_rating, headache_rating=$headache_rating, diarrhea_rating=$diarrhea_rating, soar_throat_rating=$soar_throat_rating, fever_rating=$fever_rating, muscle_ache_rating=$muscle_ache_rating, smell_loss_rating=$smell_loss_rating, cough_rating=$cough_rating, breath_rating=$breath_rating, tiredness_rating=$tiredness_rating)"
    }
}
